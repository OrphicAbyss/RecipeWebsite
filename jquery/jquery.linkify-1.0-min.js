...
(function(b){var y=/(^|["'(\s]|&lt;)((?:(?:https?|ftp):\/\/|mailto:).+?)((?:[:?]|\.+)?(?:\s|$)|&gt;|[)"',])/g,z=function(h){
if (h.search(y) != -1){
  var str1 = h.replace( y, '$1' );
  var str2 = h.replace( y, '$2' );
  var str2short = (str2.length > 61 ? str2.substr(0,60) + "&hellip;" : str2);
  var str3 = h.replace( y, '$3' );
  return str1 + '<a target="_blank" href="' + str2 + '">' + str2short + '</a>' + str3;
}
  return h;
//return h.replace(y,'$1<a target="_blank" href="$2">$2</a>$3')
