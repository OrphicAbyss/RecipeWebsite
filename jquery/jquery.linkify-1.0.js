...
(function($){
  ...
  var httpOrMailtoUrl = /(^|["'(\s]|&lt;)((?:(?:https?|ftp):\/\/|mailto:).+?)((?:[:?]|\.+)?(?:\s|$)|&gt;|[)"',])/g,
      linkifier = function ( html ) {
		  	if (html.search( httpOrMailtoUrl ) != -1){
		  	  var str1 = html.replace( httpOrMailtoUrl, '$1' );
		  	  var str2 = html.replace( httpOrMailtoUrl, '$2' );
		  	  var str2short = (str2.length > 61 ? str2.substr(0,60) + "&hellip;" : str2);
		  	  var str3 = html.replace( httpOrMailtoUrl, '$3' );
		  	  
		  	  return str1 + '<a target="_blank" href="' + str2 + '">' + str2short + '</a>' + str3;
		  	}
		  	return html;
          //return html.replace( httpOrMailtoUrl, '$1<a target="_blank" href="$2">$2</a>$3' )
        },
